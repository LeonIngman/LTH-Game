  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#e6f0ff]">
          ...
          <div className="container px-4 md:px-6">
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              ...
              <div className="flex justify-center">
                <div className="relative w-auto h-[400px] overflow-hidden rounded-xl border border-[#4d94ff] shadow-lg">
                  <Image
                    src="/images/supply-chain-map.png"
      ...
      <footer className="border-t bg-white">
        <div className="container flex flex-col gap-2 py-6 text-center text-sm text-gray-500 md:flex-row md:justify-between md:text-left">
