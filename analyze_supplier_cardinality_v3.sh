...
echo "=============================================="
echo "Supplier-Product Cardinality Analysis V3"
echo "=============================================="
...
(100, 'Patties', 'meat', 'Beef patties', 6.00),
(101, 'Buns', 'bread', 'Hamburger buns', 2.50),
(102, 'Cheese', 'dairy', 'Cheese slices', 3.50),
(103, 'Fries', 'vegetable', 'French fries', 2.00);
...
-- 1:1 relationships
(200, 100, 2, 5.50, 100, 25.00), -- MeatCorp -> Patties only
(201, 101, 1, 2.00, 200, 15.00), -- BreadBakery -> Buns only  
(202, 102, 1, 3.25, 150, 20.00), -- DairyCorp -> Cheese only
-- 1:many relationship  
(203, 100, 3, 5.75, 80, 30.00),  -- MultiSupplier -> Patties
(203, 102, 2, 3.50, 120, 25.00), -- MultiSupplier -> Cheese
(203, 103, 4, 1.90, 300, 20.00), -- MultiSupplier -> Fries
-- Another 1:1
(204, 103, 2, 1.75, 250, 18.00); -- VeggieFarms -> Fries only
" > /dev/null 2>&1
